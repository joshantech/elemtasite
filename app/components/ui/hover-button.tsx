  ...
  ({ className, children, ...props }, ref) => {
    ...
    return (
      <button
        ref={buttonRef}
        className={cn(
          "relative isolate px-8 py-3 md:px-12 md:py-4 rounded-3xl",
          "text-foreground font-medium text-base md:text-lg leading-6 md:leading-7",
        ...
        style={{
          ...
          fontFamily: "'CaviarDreams', Arial, Helvetica, sans-serif",
